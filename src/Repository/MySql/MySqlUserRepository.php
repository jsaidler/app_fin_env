...
class MySqlUserRepository implements UserRepositoryInterface
{
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO users (name,email,password_hash,role,theme,alterdata_code,created_at) VALUES (:name,:email,:ph,:role,:theme,:alterdata_code,NOW())');
        $stmt->execute([
            'name' => $name,
            'email' => $email,
            'ph' => $passwordHash,
    ...
    {
        $rows = $this->pdo->query('SELECT * FROM users ORDER BY created_at DESC')->fetchAll();
